...
\begin{itemize}[nosep]
    ...
    \item Der Pi hält sein Betriebssystem selbst aktuell und startet
          dafür gelegentlich vormittags um 10:00 kurz neu. Das ist normal;
          nach wenigen Minuten läuft die Steuerung wieder.
\end{itemize}
