...
\begin{enumerate}[nosep]
    \item Am Dashboard bei der Anlage \emph{Image erstellen} klicken. Der
...
Den Fortschritt zeigt das Dashboard bei der Anlage an (die Seite
aktualisiert sich selbst), ebenso die Mitgliedsseite
...
\begin{itemize}[nosep]
    ...
    \item Anmeldung auf \url{https://remote.hac.ischlstrom.org} mit dem
          Cloud-Konto der Anlage (Benutzer und Passwort stehen am
          Dashboard unter \emph{Passwörter anzeigen}): die
