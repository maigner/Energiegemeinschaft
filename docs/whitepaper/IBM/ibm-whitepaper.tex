...
Schätzung ein; ein Entladebefehl bricht die laufende Messstrecke ab, die
nächste beginnt im nächsten Zyklus ohne Entladung. Gemessen wird so vor dem
ersten Entladen, nach dem Entlade-Stopp, bei Budget null, beim Trüb-Stopp
ohne Budget
und unterhalb der Reserve. Eine Messung nur unterhalb der Reserve, wie
anfangs vorgesehen, käme bei großen Batterien nie zustande: Ohne Budget
sinkt der Ladestand nicht unter die Reserve. Aus dem Wert rechnet das
Gateway die Eigenbedarfsreserve des Nachtbudgets
(Abschnitt~\ref{sec:nachtbudget}); per Status-Push geht er auch an den
Server, dort nur zur Anzeige.
