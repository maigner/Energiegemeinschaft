#!/bin/bash
# Installiert den taeglichen EEG-Faktura-Import auf s1 (vom Entwicklungsrechner
# aus, wie scripts/ibm-provision/install-on-s1.sh): kopiert dieses Verzeichnis
# plus notebooks/energyData/eegfaktura_import.py und
# notebooks/forecast/eeg_forecast.py nach s1 und fuehrt dort setup-on-s1.sh
# als root aus. sudo auf s1 fragt nach dem Passwort. Wiederholbar - auch fuer
