            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/kosten.jpeg" width="100%" alt="sponsors" />
                        </div>
            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/energiewende.png" width="100%" alt="sponsors" />
                        </div>
                        <div slot="content">
            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/unabhängig.jpeg" width="100%" alt="sponsors" />
                        </div>
                        <div slot="content">
            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/umwelt.jpeg" width="100%" alt="sponsors" />
                        </div>
                        <div slot="content">
            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/versorgung.jpeg" width="100%" alt="sponsors" />
                        </div>
                        <div slot="content">
            ...
            <Cell span={6}>
                <div>
                    <Project>
                        ...
                        <div slot="image">
                            <img src="tmp/vernetzt.jpeg" width="100%" alt="sponsors" />
                        </div>
                        <div slot="content">
