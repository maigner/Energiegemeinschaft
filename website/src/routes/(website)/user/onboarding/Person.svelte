...
<FirstName bind:firstName={applicationData.firstName} />
<LastName bind:lastName={applicationData.lastName} />
...
/>
<CheckDataProcessing
    bind:privacyNotice={applicationData.checkBoxes.privacyNotice}
/>
